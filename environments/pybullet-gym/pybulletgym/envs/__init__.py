...
register(
	id='InvertedDoublePendulumSparsePyBulletEnv-v0',
	entry_point='pybulletgym.envs.roboschool.envs.pendulum.inverted_double_pendulum_env_sparse:InvertedDoublePendulumSparseBulletEnv',
	max_episode_steps=1000,
	reward_threshold=9100.0,
	)
